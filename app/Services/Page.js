...
const Services= () => {
  return (
    ...
    <div className=' h-[18rem] w-[20rem] border-[3px] border-green-500 shadow-md shadow-white '>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Deleniti, eum.</div>
    <div className=' h-[18rem] w-[20rem] border-[3px] border-green-500 shadow-md shadow-white '>Lorem, ipsum dolor.</div>
